package com.sqlpractice.config;
...
import com.sqlpractice.model.entities.Payment;
...
import com.sqlpractice.model.repositories.OrderItemRepository;
...
@Configuration
@Profile("test")
@EnableJpaRepositories(basePackages = "com.sqlpractice.*")
